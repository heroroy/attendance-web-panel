    ...
    return (
        <>
            <details ref={detailsRef} className="dropdown details-modal">
                <summary
                    className="btn m-1 inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-5 cursor-pointer collapse">
                    {value}
